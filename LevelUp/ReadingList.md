...
- [What happens when you do `kubectl run nginx` under the hood](https://www.youtube.com/watch?v=LLuUhU3SwJo)
- [How k8s Service works under the hood](https://www.youtube.com/watch?v=uP4Gc08qeXM)
- [How does Scheduler picks up a Node?](https://www.youtube.com/watch?v=N-dDSCVWdqU)
